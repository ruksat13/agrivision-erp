...
const initialSuppliers = [
  { id: 1, name: 'ACI Limited', phone: '01711-111111', email: 'aci@email.com', area: 'Dhaka', balance: 25000, status: 'Active' },
  { id: 2, name: 'Square Pharma', phone: '01811-222222', email: 'square@email.com', area: 'Dhaka', balance: 18000, status: 'Active' },
  { id: 3, name: 'Syngenta BD', phone: '01911-333333', email: 'syngenta@email.com', area: 'Chittagong', balance: 0, status: 'Active' },
  { id: 4, name: 'BASF BD', phone: '01611-444444', email: 'basf@email.com', area: 'Dhaka', balance: 12000, status: 'Inactive' },
  { id: 5, name: 'Bayer BD', phone: '01511-555555', email: 'bayer@email.com', area: 'Sylhet', balance: 8000, status: 'Active' },
];
    ...
    <div style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '20px' }}>
        ...
        <div style={{ ...cardStyle, textAlign: 'center', borderTop: '4px solid #dc3545' }}>
          ...
          <p style={{ fontSize: '22px', fontWeight: 'bold', margin: 0, color: '#dc3545' }}>৳ {totalBalance.toLocaleString()}</p>
        </div>
      </div>
